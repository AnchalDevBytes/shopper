...
const FeaturedProducts = ({tinyText,text, categoryData, loading}) => {
    ...
    const topProducts = categoryData?.slice(0,3);
  ...
  return (
    <section className="bg-fuchsia-950/50 min-h-screen md:min-h-[70vh] items-center justify-center py-10 lg:py-20">
      ...
      {
        loading ? (
            <div className="flex items-center flex-col gap-7 md:flex-row justify-center text-3xl font-medium pt-10 lg:pt-24">...loading...</div>
        ) : (
