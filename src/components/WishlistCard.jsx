    ...
    return (
        <div className="flex p-2 md:p-5 bg-fuchsia-950 hover:bg-gradient-to-br gap-4 md:justify-normal md:gap-7 lg:gap-20 hover:from-fuchsia-950 hover:to-purple-950/70 mx-2 md:mx-5 lg:mx-32 rounded-2xl">
          ...
          <div className="flex flex-col gap-1 md:gap-2 max-w-[100px] md:max-w-xs lg:max-w-md">
            <Link href={`/product-detail/${product?.id}`} className="font-bold text-sm hover:text-pink-400/50 cursor-pointer active:text-pink-400/70 md:text-2xl lg:text-3xl">
              {product?.title}
            </Link>
          ...
          <div className="flex flex-col gap-1">
            ...
            <p className="text-sm text-gray-300 font-bold flex items-center gap-1">
                  {" "}
                  Rating:{" "}
                  <span className=" text-xs text-gray-300 flex gap-1 ">
