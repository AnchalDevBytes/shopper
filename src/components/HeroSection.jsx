  ...
  return (
    ...
    >
      <div className="h-screen bg-gradient-to-br from-fuchsia-950/95 to-purple-800/20 flex flex-col items-center justify-center gap-20 lg:gap-5 backdrop-filter backdrop-blur-xl relative">
        <h1
          className="lg:text-[50px] md:text-2xl text-sm md:mb-20 tracking-[10px] md:tracking-[35px] lg:tracking-[50px] font-montserrat border-b-8 leading-none text-center font-thin pb-4 md:pb-10 md:-mt-72 px-5 lg:mt-10 border-dotted border-fuchsia-700 rounded-b-[100px] z-0 welcome-animation"
         >
            welcome
         </h1>
        <p 
          className="lg:text-[250px] md:text-[120px] text-7xl lg:-my-32 md:-my-28 font-extrabold z-10 tracking-widest text-fuchsia-300 to-animation"
        >
          to
        </p>
        <h2
           ...
           >
              {displayText}
              <span
                 className="font-thin text-white lg:text-7xl text-5xl animate-pulse"
                >
                  |
              </span>
        </h2>
