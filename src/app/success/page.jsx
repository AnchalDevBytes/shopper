    ...
    <div className='flex flex-col items-center justify-center h-screen bg-fuchsia-950/50 text-center'>
     <div className='flex flex-col gap-10 mx-10'>
        <div className='flex items-center gap-4'>
          <FaCheckCircle className='text-4xl md:6xl' /> 
          <h1 className='text-2xl md:text-3xl font-bold text-green-500 tracking-wider'>Payment Successful !</h1>
        </div>
        <div className='flex max-w-sm flex-col gap-2 text-center mx-10'>
