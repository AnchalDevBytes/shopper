    ...
    return (
        <div className="bg-fuchsia-950 min-h-screen flex flex-col justify-center items-center">
            <div className="max-w-4xl px-6 py-12 bg-purple-950 shadow-lg rounded-lg">
                ...
                I&lsquo;m Anchal Raj, a frontend developer passionate about building modern web applications using technologies like React, Next.js, and other frontend tools.
                </p>
